# Taken from https://gist.githubusercontent.com/finetuneanon/b814e702b1e2e150d2e263f6a75f4650/raw/e19b75a83949133960bdae3eb48ba021c8efab86/conv.py
import torch
import numpy as np
...
if len(sys.argv) < 3:
    print("Usage: python convert_to_pytorch.py in_ckpt out_dir")
    exit()
